...
os.system("python3 " + basedir + "iridium-parser.py " + file_to_process + " > " + workdir + "/iridium-packets.txt")
...
os.system("python3 " + basedir + "voc-cluster.py " + workdir + "/voc.bits")
...
for filename in os.listdir(workdir + "/samples/"):
	...
	os.system("python3 " + basedir + "bits_to_dfs.py " + workdir + "/samples/" + filename + " " + workdir + "/samples/" + filename.replace(".msg","") + ".dfs")
